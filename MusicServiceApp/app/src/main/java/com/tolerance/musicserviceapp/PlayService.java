...
public class PlayService extends Service implements  MediaPlayer.OnCompletionListener {
            ...
            if (mode != null) {
                if (mode.equals("start")) {
                    try {
                        ...
                        Intent aIntent = new Intent("com.tolerance.PLAY_TO_ACTIVITY");
    ...
    public void onCreate() {
        super.onCreate();
        registerReceiver(receiver, new IntentFilter("com.tolerance.PLAY_TO_SERVICE"));
    }
    ...
    public void onCompletion(MediaPlayer mp) {
        Intent intent = new Intent("com.tolerance.PLAY_TO_ACTIVITY");
